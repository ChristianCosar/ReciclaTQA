 ...
 */
public class PhoneDialog extends AlertDialog implements Validator.ValidationListener {
    private String field;
    private Validator validator;
    private EditCompanyView editCompanyView;

    @Length(min = 7, max = 7, message = "Número de teléfono inválido")
    EditText editText_parameter;
    Button btn_add_control;

    public PhoneDialog(Context context, EditCompanyView editCompanyView,String field){
        super(context);
    ...
    private void initDialog() {
        ...
        editText_parameter = (EditText) view.findViewById(R.id.tv_company_phone);
    ...
    public void onValidationSucceeded() {
        this.dismiss();
        editCompanyView.editPhone(editText_parameter.getText().toString());
