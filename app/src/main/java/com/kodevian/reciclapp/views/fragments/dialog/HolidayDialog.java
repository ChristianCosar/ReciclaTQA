 ...
 */
public class HolidayDialog extends AlertDialog implements Validator.ValidationListener {
    ...
    public HolidayDialog(Context context, EditCompanyView editCompanyView,String field){
        super(context);
    ...
    private void initDialog() {
        ...
        final View view = inflater.inflate(R.layout.dialog_holiday, null);
        setView(view);

        btn_add_control = (Button) view.findViewById(R.id.btn_edit);
        editText_parameter = (EditText) view.findViewById(R.id.tv_atention_m_f_h);
    ...
    public void onValidationSucceeded() {
        this.dismiss();
        editCompanyView.atention_holiday(editText_parameter.getText().toString());
